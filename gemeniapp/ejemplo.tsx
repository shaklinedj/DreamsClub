...
const TabButton = ({ active, icon, label, onClick, notification }) => (
  <button 
    onClick={onClick}
    className={`flex flex-col items-center justify-center w-full py-3 transition-colors duration-300 relative ${
      active ? 'text-[#D4AF37]' : 'text-gray-400 hover:text-gray-200'
    }`}
  >
    {notification && (
