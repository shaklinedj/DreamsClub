...
class RestaurantDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: SafeArea(
        top:
            false, // Keep top immersive if desired, but user complained. Let's try top: true effectively by just using SafeArea default.
        // Actually, if I use SafeArea, the SliverAppBar won't be at the top of the screen.
        // But if the user says "passing under", they probably see the text or back button obscured.
        // SliverAppBar should handle this.
        // Let's try wrapping the whole Scaffold body in SafeArea.
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildMenuItem(context, 'Bife de Chorizo',
                        'Acompañado de papas rústicas', '\$25.000'),
                    _buildMenuItem(context, 'Salmón a la Parrilla',
                        'Con vegetales salteados', '\$22.000'),
                    _buildMenuItem(context, 'Pasta Trufada',
                        'Salsa cremosa de trufas negras', '\$18.000'),
                    const SizedBox(height: 24),
                    SizedBox(
